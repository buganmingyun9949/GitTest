...
namespace Plugin.Exam.Qs.ViewModel
{
    ...
    public class EssayChoiceViewModel : QsBaseViewModel
    {
        ...
        public EssayChoiceViewModel(int qsIndex, int itemIndex)
        {
            QsIndex = qsIndex;
        ...
        public EssayChoiceViewModel(StackPanel subChoiceQsContent, Paper_DetailItem paperDetail, Button btn, int qsIndex, int itemIndex, string item_id = null) : this(qsIndex, itemIndex)
        {
