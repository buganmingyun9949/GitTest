...
namespace Plugin.Exam.Qs.ViewModel.SubItem
{
    ...
    /// 听小对话 回答问题
    /// </summary>
    public class SubTextChoiceViewModel: QsBaseViewModel
    {
        ...
        public SubTextChoiceViewModel()
        {
        }

        public SubTextChoiceViewModel(Paper_ItemsItem paperSubItemDetail, int subIndex, int showIndexNum) : this()
        {
        ...
        public void UpdateSubChoiceAnswer(string qsId,string qsType)
        {
            ...
            for (int i = 0; i < _paperSubItemDetail.answers.Count; i++)
            {
                if ((i + 1) == Int32.Parse(_AnswerOrder))
                {
                    ...
                    myAnswer = _paperSubItemDetail.answers[i].answer_content;
                    break;
                }
            }
        ...
        
        {
            ...
            var answerItem = _paperSubItemDetail.answers.Where(w => w.answer_content == answer).ToList();
            ...
            int indexof = _paperSubItemDetail.answers.IndexOf(answerItem[0]);
            switch (indexof)
            {
                case 0:
                    name = "A";
