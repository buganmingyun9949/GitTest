...
namespace Plugin.Exam.Qs.ViewModel
{
    ...
    /// 短文理解
    /// </summary>
    public class Spoken1902ViewModel : QsBaseViewModel
    {
        ...
        public Spoken1902ViewModel(int qsIndex, int itemIndex)
        {
            QsIndex = qsIndex;
        ...
        private void UpdateAnswer()
        {
            if (_subChoiceQsContent.Children.Count > 0)
            {
                ...
                {
                    var subView = _subChoiceQsContent.Children[i] as SubTextChoice1View;

                    var subVM = subView.DataContext as SubTextChoice1ViewModel;
