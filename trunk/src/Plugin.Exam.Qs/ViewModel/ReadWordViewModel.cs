...
namespace Plugin.Exam.Qs.ViewModel
{
    ...
    /// 朗读句子
    /// </summary>
    public class ReadWordViewModel : QsBaseViewModel
    {
        public new QuestionType QsType = QuestionType.RepeatImitate;
        public const string ViewName = "ReadWordViewModel";
        ...
        /// 朗读句子
        /// </summary>
        public ReadWordViewModel(int qsIndex, int itemIndex)
        {
            QsIndex = qsIndex;
        ...
        public ReadWordViewModel(Paper_DetailItem paperDetail, Button btn, int qsIndex, int itemIndex, string item_id = null) : this(qsIndex, itemIndex)
        {
