...
namespace Plugin.Exam.Qs.ViewModel
{
    ...
    /// 信息获取。
    /// </summary>
    public class ObtainInfoViewModel1 : QsBaseViewModel
    {
        public new QuestionType QsType = QuestionType.HearingSingleChoice;
        public const string ViewName = "ObtainInfoViewModel1";
        ...
        /// 信息获取。
        /// </summary>
        public ObtainInfoViewModel1(int qsIndex,int infoIndex, int itemIndex)
        {
            QsIndex = qsIndex;
        ...
        public ObtainInfoViewModel1(Paper_DetailItem paperDetail, Button btn, int qsIndex, int infoIndex, int itemIndex = 0) : this(qsIndex, infoIndex, itemIndex)
        {
        ...
        public override void BeginExam(ExamFlowType nextFlowType)
        {
            ...
            switch (nextFlowType)
            {
                ...
                case ExamFlowType.PrepareTime:
                    ...
                    TotalTime = PaperItems[_infoIndex].info_prepare_second;
                    PlayTime = 0;
                    SendProgress();
