...
namespace Plugin.Exam.Qs.ViewModel
{
    ...
    /// 朗读句子
    /// </summary>
    public class ReadSentenceViewModel : QsBaseViewModel
    {
        public new QuestionType QsType = QuestionType.RepeatImitate;
        public const string ViewName = "ReadSentenceViewModel";
        ...
        /// 朗读句子
        /// </summary>
        public ReadSentenceViewModel(int qsIndex, int itemIndex)
        {
            QsIndex = qsIndex;
        ...
        public ReadSentenceViewModel(Paper_DetailItem paperDetail, Button btn, int qsIndex, int itemIndex, string item_id = null) : this(qsIndex, itemIndex)
        {
        ...
        private void BindQsItemInfo(string item_id = null)
        {
            ...
            else
            {
                //默认取第一题
                //PaperItems
                QsItemContent = $"{PaperItems[_itemIndex].items[0].item_content}";//{_itemIndex + 1}、
        ...
        private void UpdateAnswer()
        {
            ...
            Messenger.Default.Send(
                new ExamScoreNavigateMessage(model, _waveFileName, EngineQsType.READING, EngineType.SENT),
                "ExamScoreNavi");
        }
