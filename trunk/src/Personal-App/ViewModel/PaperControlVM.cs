...
namespace Personal_App.ViewModel
{
    public class PaperControlVM : MainViewModel
    {
            ...
            get
            {
                return startExamCommand ?? (startExamCommand = new RelayCommand(
                           (action) =>
                           {
                               ...
                               GlobalUser.SelectPaperName = GlobalUser.SelectPaperViewName = paperItem.Name;//paper_title;
        ...
        public PaperControlVM(SimulationItem _paperItem, int index) : this()
        {
