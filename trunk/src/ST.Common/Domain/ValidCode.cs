...
namespace ST.Common.Domain
{
    public class ValidCode
    {
        ...
        private readonly Single _jianju = (float)16.0;

        private readonly Single _height = (float)20.0;
        ...
        public Stream CreateCheckCodeImage()
        {
            ...
            try
            {
                ...
                LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(0, 0, image.Width, image.Height), Color.DarkBlue, Color.DarkRed, 1.2f, true);
                ...
                if (_codetype != CodeType.Words)
                {
                    image = TwistImage(image, false, 1.5, 1);
                }
        ...
        /// <returns></returns>
        public bool MatchValidCode(string inputCode)
        {
            return (inputCode.ToUpper() == CheckCode.ToUpper());
        }
