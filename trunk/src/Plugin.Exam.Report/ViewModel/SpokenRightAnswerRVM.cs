...
{
    public class SpokenRightAnswerRVM : QsBaseRVM
    {
        #region << 属性 >>
        ...
        public SpokenRightAnswerRVM(StackPanel qsItemContent, Paper_DetailItem paperDetail, Exam_Attend_Result examResult)
        {
        ...
        private void BindSubItemChoice()
        {
           ...
           //TitleTwo = detailInfo.info_content;
            ...
            for (int i = 0; i < PaperDetail.info.Count; i++)
            {
                ...
                var itemView = new SubSpokenRightAnswerRV();
                itemView.DataContext =
                    new SubSpokenRightAnswerRVM(PaperDetail.info[i], i, itemAnswerResult, false);
