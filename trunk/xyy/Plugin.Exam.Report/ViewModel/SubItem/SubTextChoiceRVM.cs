...
namespace Plugin.Exam.Report.ViewModel.SubItem
{
    ...
    /// 选择
    /// </summary>
    public class SubTextChoiceRVM : QsBaseRVM
    {
        ...
        public SubTextChoiceRVM(Paper_ItemsItem paperItemsItem, int itemIndex, Exam_Attend_Result_Item examItemResult, bool showPlayBtn = true)
        {
            CleanUp();
