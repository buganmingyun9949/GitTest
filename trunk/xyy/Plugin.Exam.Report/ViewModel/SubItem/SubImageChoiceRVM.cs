...
namespace Plugin.Exam.Report.ViewModel.SubItem
{
    ...
    public class SubImageChoiceRVM : QsBaseRVM
    {
        ...
        public SubImageChoiceRVM(Paper_ItemsItem paperItemsItem, int itemIndex, Exam_Attend_Result_Item examItemResult, bool showPlayBtn = true)
        {
            ...
            QsTitle1 = $"{itemIndex + 1}、{paperItemsItem.item_content}";
            ...
            ChoiceTextA = new BitmapImage(new Uri($"{WebApiProxy.MEDIAURL}{paperItemsItem.answers[0].source_content}"));
            ChoiceTextB = new BitmapImage(new Uri($"{WebApiProxy.MEDIAURL}{paperItemsItem.answers[1].source_content}"));
            ChoiceTextC = new BitmapImage(new Uri($"{WebApiProxy.MEDIAURL}{paperItemsItem.answers[2].source_content}"));
