    ...
    public class SpokenOesyViewModel : QsBaseViewModel
    {
        ...
        private void BindQsItemInfo(string item_id = null)
        {
            ...
            else
            {
                ...
                {
                    QsInfoImage = new BitmapImage(new Uri($"{WebApiProxy.MEDIAURL}{PaperItems[0].source_content}"));
                }
                ...
                {
                    QsInfoImage = new BitmapImage(new Uri($"{WebApiProxy.MEDIAURL}{PaperItems[0].items[_itemIndex].img_source_content}"));
                }
