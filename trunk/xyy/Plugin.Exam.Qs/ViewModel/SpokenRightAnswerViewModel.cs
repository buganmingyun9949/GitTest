...
namespace Plugin.Exam.Qs.ViewModel
{
    ...
    /// 听句子，选择正确答语。
    /// </summary>
    public class SpokenRightAnswerViewModel : QsBaseViewModel
    {
        public new QuestionType QsType = QuestionType.RepeatImitate;
        public const string ViewName = "SpokenRightAnswerViewModel";
        ...
        /// 听句子，选择正确答语。
        /// </summary>
        public SpokenRightAnswerViewModel(int qsIndex, int itemIndex)
        {
            QsIndex = qsIndex;
        ...
        public SpokenRightAnswerViewModel(Paper_DetailItem paperDetail, Button btn, int qsIndex, int itemIndex, string item_id = null) : this(qsIndex, itemIndex)
        {
        ...
        private void BindQsItemInfo(string item_id = null)
        {
            ...
            else
            {
                //默认取第一题
                //PaperItems
                QsItemContent = PaperItems[_itemIndex].info_content;
