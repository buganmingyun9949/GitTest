...
namespace MahApps.Metro.Controls.Dialogs
{
    ...
    /// </summary>
    public partial class MessageDialogConfirm : BaseMetroDialog
    {
        internal MessageDialogConfirm()
            : this(null)
        {
        }

        internal MessageDialogConfirm(MetroWindow parentWindow)
            : this(parentWindow, null)
        {
        }

        internal MessageDialogConfirm(MetroWindow parentWindow, MetroDialogSettings settings)
        ...
        public static readonly DependencyProperty ButtonStyleProperty = DependencyProperty.Register("ButtonStyle", typeof(MessageDialogStyle), typeof(MessageDialog), new PropertyMetadata(MessageDialogStyle.Affirmative, new PropertyChangedCallback((s, e) =>
                                                                                                                                                                                                                                                           {
                                                                                                                                                                                                                                                               MessageDialogConfirm md = (MessageDialogConfirm)s;
