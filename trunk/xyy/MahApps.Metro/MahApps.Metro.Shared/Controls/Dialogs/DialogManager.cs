...
namespace MahApps.Metro.Controls.Dialogs
{
    ...
    public static class DialogManager
    {
        ...
        private static Window CreateModalExternalWindow(MetroWindow window, int? showWidth = null, int? showHeight = null)
        {
            var win = CreateExternalWindow();
            win.Owner = window;
            ...
            win.Width = showWidth ?? window.ActualWidth;
            win.MaxHeight = showHeight ?? window.ActualHeight;
            win.SizeToContent = SizeToContent.Height;
        ...
        /// <param name="settings">Optional settings that override the global metro dialog settings.</param>
        /// <returns>A task promising the result of which button was pressed.</returns>
        public static MessageDialogResult ShowModalMessageExternal(this MetroWindow window, string title, string message, MessageDialogStyle style = MessageDialogStyle.Affirmative, MetroDialogSettings settings = null, int? showWidth = null, int? showHeight = null)
        {
